...
interface FormFieldsProps {
  form: ItemPatrimonioRequest
  colaboradores: ColaboradorResponse[]
  handleChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void
}

function FormFields({ form, colaboradores, handleChange }: FormFieldsProps) {
  return (
      <>
        <div>
            ...
            <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50"
              ...
              <div className="bg-surface border border-border w-full max-w-md p-6"
                ...
                <form onSubmit={handleCadastrar} className="flex flex-col gap-3">
                  <FormFields form={form} colaboradores={colaboradores} handleChange={handleChange} />
